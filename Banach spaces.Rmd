...
We call this function a norm, hopefully you're familiar with the $R^2$ norm,
...
This norm can be used to define a metric on X by letting $\rho$(x, y) = $\|x - y\|$. Let's say that $X$ is the space $L^2$; the space of all real f such that $\int$ $|f|^2$dx < $\infty$, where dx represents the Lebesgue measure on $R$. We can define a norm on this space:

$\|f\|$ = {$\int$ $|f|^2$dx}$^\frac{1}{2}$ 
This norm gives rise to the metric:

$\rho$(f, g) = $\|f - g\|$ = {$\int$$|f - g|^2$dx}$^\frac{1}{2}$
...
Baire's (Category) Theorem: The intersection of any countable collection of dense open sets in a complete metric space, is a dense set
